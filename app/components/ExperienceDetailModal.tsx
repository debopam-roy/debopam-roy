...
export default function ExperienceDetailModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-3 backdrop-blur-sm sm:px-4"
      onClick={onClose}
    >
      <div
        className="relative flex max-h-[85vh] w-full max-w-2xl flex-col overflow-hidden rounded-sm border-2 border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] sm:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Fixed Header */}
        <div className="shrink-0 border-b-2 border-gray-100 px-5 pt-5 pb-4 sm:px-6 sm:pt-6 sm:pb-4 md:px-8 md:pt-8 md:pb-4">
          {/* Close button */}
          <button
            onClick={onClose}
